...
extension RelayCryptoTests {
    /// Cross-language vector generated by tools/tokenserver/pairing.py —
    /// the watch must decrypt exactly what the Mac announces.
    func testRendezvousVector() {
        XCTAssertEqual(Rendezvous.codeID("123456"),
            "3388fb0d2dcb96c51b6303cbfd1f9365cc81abf446d791f0f7fb40ec43f0eba8")
        let payload = "Zqn7qtEmBcImCPgV542q4P9OD726LGc_ZgOSXANaoSoCL1GHs1UVy68VDytsAfUgAGYxE3eDKhuwUsagrK-GDHPI4VJMjp62boPm"
        let plain = Rendezvous.decrypt(code: "123456", payload: payload)
        XCTAssertEqual(plain.flatMap { String(data: $0, encoding: .utf8) },
                       #"{"hosts":["203.0.113.7"],"port":8737,"v":1}"#)
        XCTAssertNil(Rendezvous.decrypt(code: "123457", payload: payload))
    }
}
